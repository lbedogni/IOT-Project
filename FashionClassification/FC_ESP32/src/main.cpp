...
#include "FashionClassification.h"
...
void setup() {
    ...
    // Dal file Header (FashionClassification.h):
    // modello tensorflow -> FashionClassificationModel

    if ( ! model.begin(FashionClassificationModel) ) {
